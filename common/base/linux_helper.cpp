...
namespace Astra
{
	...
	/*static*/ bool LinuxHelper::MakeDirectoryForFile(const std::string file_name)
	{
		return true;
	}

	/*static*/ void LinuxHelper::SetSignalHandler(int signal_value, void (*handler)(int))
	{
